...
% function reduced_features = reduce_feat_dim(features, perc_accepted)
% % examples:
...
% sum_eig = sum(explained);
% %perc_accepted = 0.95; % 144
% for M_pca = 1:size(explained)
%     if sum(explained(1:M_pca))/sum_eig > perc_accepted
%         break
%     end
% end
% 
